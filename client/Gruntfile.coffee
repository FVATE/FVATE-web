module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    concat:
      vendor_scripts:
        src: [
          "#{VENDOR_DIR}/**/jquery/jquery-1.10.2.min.js",
          # "#{VENDOR_DIR}/**/jquery/jquery.bxslider.min.js",
          "#{VENDOR_DIR}/**/jquery/jquery.scrollTo-1.4.3.1-min.js",
          # "#{VENDOR_DIR}/**/jquery/jquery.sharrre.min.js",

          "#{VENDOR_DIR}/**/bootstrap/bootstrap.min.js",

          # "#{VENDOR_DIR}/**/jquery/masonry.pkgd.min.js",
          "#{VENDOR_DIR}/**/jquery/modernizr.custom.js",
          "#{VENDOR_DIR}/**/jquery/page-transitions.js",
          "#{VENDOR_DIR}/**/jquery/easing.min.js",

          "#{VENDOR_DIR}/**/jquery/jquery.svg.js",
          "#{VENDOR_DIR}/**/jquery/jquery.svganim.js",
          # "#{VENDOR_DIR}/**/jquery/jquery.backgroundvideo.min.js",
          # "#{VENDOR_DIR}/**/jquery/froogaloop.min.js",

          "#{VENDOR_DIR}/**/startup-kit/startup-kit-plugins.js",
          "#{VENDOR_DIR}/**/startup-kit/startup-kit.js",
          # "#{VENDOR_DIR}/**/startup-kit/startup-kit-videobg.js",
          "#{VENDOR_DIR}/**/startup-kit/startup-kit-init.js",
          "#{VENDOR_DIR}/**/startup-kit/startup-kit-hide-collapse-menu.js",

          "#{VENDOR_DIR}/**/startup-kit/startup-kit-header-23.js",
          "#{VENDOR_DIR}/**/startup-kit/startup-kit-header-23-fullscreen.js",

          "#{VENDOR_DIR}/**/startup-kit/swipe.js",
        ]
      ...
      vendor_styles:
        src: [
          ...
          "#{VENDOR_DIR}/**/flat-ui/*.css",
          "#{VENDOR_DIR}/**/icon-font/*.css",
          "#{VENDOR_DIR}/**/startup-kit/styles.css",
          # "#{VENDOR_DIR}/**/*.css",
        ]
    ...
    # # convert angular files that use simple injects to their build-safe
    # # versions
    # ngmin:
    #   app:
    #     expand: true
   ...
   * 4. generate a JS file containing all angular templates.
   * 5. generate build-safe versions of angular controllers, services, directives, filters, etc.
